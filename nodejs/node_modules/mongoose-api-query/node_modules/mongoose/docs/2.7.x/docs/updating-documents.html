...
<p>Keep in mind that that the <code>safe</code> option specified in your schema is used by default when not specified here.</p>
...
<li>setters</li>
<li>validators</li>
<li>middleware triggered on <code>save</code></li>
</ul>
